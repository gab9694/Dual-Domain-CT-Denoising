...
def read_dicom(parser):
    ...
    du = unpack_tag(data_headers[0], 0x70291002)  # DetectorElementTransverseSpacing, detector column
    dv = unpack_tag(data_headers[0], 0x70291006)  # DetectorElementAxialSpacing, detector row
    ...
    dsd = unpack_tag(data_headers[0], 0x70311031)  # ConstantRadialDistance, Anode-to-detector Distance (mm) 
